package com.mmj.beprepared.mapper;

import com.mmj.beprepared.dto.request.AlertRequestDto;
import com.mmj.beprepared.dto.request.CitizenRequestDto;
import com.mmj.beprepared.dto.request.UserRequestDto;
import com.mmj.beprepared.dto.response.*;
import com.mmj.beprepared.model.*;
...
public class Mapper {
    ...
    private final ModelMapper modelMapper; /*Vamos fazer uma injencao de dependencia*/
    ...
    public AlertResponseDto mapAlertToResponseDto(Alert alert) {  /*Metodo para mapear o alerta par ao response Dto, o que vamos retornar e o que desejamos ja mapeado*/
